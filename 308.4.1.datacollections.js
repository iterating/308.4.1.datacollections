...
console.groupEnd();
console.group(`Pt 2 CSV to Array`);
...
console.groupEnd();
console.group(`Part 3 Array of Objects`);
...
console.groupEnd();
console.group(`Pt 4 Sorting and Manipulating Dat `);
...
console.groupEnd();
console.group(`Pt 5 Convert to CSV`);
...
function arrayToCsv(arrayofObjects) {
    ...
    let rows = arrayofObjects.map((obj) =>
